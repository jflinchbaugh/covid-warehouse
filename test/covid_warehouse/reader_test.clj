...
(deftest test-fix-date
  (testing "fix-date"
    (are [in out] (= out (fix-date in))
      {:date "01/02/2010"} {:date "2010-01-01"}
      {:date "01/02/10"} {:date "2010-01-01"}
      {:date "01/02/2010 01:01"} {:date "2010-01-01"}
      {:date "01/02/10 01:01"} {:date "2010-01-01"}
      {:date "2010-01-02T01:01:01"} {:date "2010-01-01"}
      {:date "2010-01-02 01:01:01"} {:date "2010-01-01"}
      {:date "2010-01-02 01:01"} {:date "2010-01-01"}
      ))
